...
export const metadata = {
  ...
  description: "Invest in pre-rented properties in Delhi with active leases and steady rental income. Discover commercial and residential options with high ROI.",
  icons: {
    icon: '/logo.webp'
  }
};
