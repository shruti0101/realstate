    ...
    <div className="px-6 py-6">
      <form onSubmit={handleSubmit} className="space-y-4">
        ...
        <input
          ...
          className="w-full px-4 py-3 bg-white border border-slate-300 rounded-lg text-black placeholder-slate-500 focus:ring-2 focus:ring-[#ed3a20] transition"
          required
        />
        ...
        <textarea
          ...
          className="w-full px-4 py-3 bg-white border border-slate-300 rounded-lg text-black placeholder-slate-500 focus:ring-2 focus:ring-[#ed3a20] transition h-24 resize-none"
          required
        ></textarea>
